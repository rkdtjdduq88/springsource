...
<form action='<c:url value="/member/register"/>' method="post" novalidate>
  ...
  <div class="mb-3">
    ...
    <input type="radio" class="form-check-input" id="" name="gender" value="남" required>남 
    <input type="radio" class="form-check-input" id="" name="gender" value="여" required>여
    <div class="invalid-feedback">
     	성별을 확인해 주세요
    </div>
  </div>
  <div class="mb-3">
    ...
    <input type ="email" class="form-control" id="email" name="email" placeholder="이메일" required></textarea>
    <div class="invalid-feedback">
     	이메일을 확인해 주세요
    </div>
  </div>
